...
function Notify(
  ...
  c.setAttribute('class', `notify notify--${e}`),
    c.classList.add('animate'),
    setTimeout(() => c.classList.remove('animate'), 300),
  ...
  'top' === o.split(' ')[0] && s.insertAdjacentElement('afterbegin', c),
    'bottom' === o.split(' ')[0] && s.insertAdjacentElement('beforeend', c),
    1 * i > 0 &&
      setTimeout(() => {
...
//# sourceMappingURL=/sm/7e2acab9ea07f776a694249c32f438b2ab984685a6f50ea3c60727f883b3fe67.map
