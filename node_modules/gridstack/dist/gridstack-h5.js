        ...
        var t = {
                21: (t, e, i) => {
                    ...
                    (e.GridStackDD = n),
                            ...
                            return (
                                n
                                    ...
                                    .on(this.el, "dropover", (o, r, a) => {
                                        ...
                                        (t = { top: d.top, left: d.left }), (i = this.cellWidth()), (e = this.getCellHeight(!0)), h || (h = this._readAttr(r)), h.grid || ((h._isExternal = !0), (r.gridstackNode = h)), (a = a || r);
                                        let g = h.w || Math.round(a.offsetWidth / i) || 1,
                                            p = h.h || Math.round(a.offsetHeight / e) || 1;
                                        return (
                                            h.grid && h.grid !== this
                                                ? (r._gridstackNodeOrig || (r._gridstackNodeOrig = h),
                                                  (r.gridstackNode = h = Object.assign(Object.assign({}, h), { w: g, h: p, grid: this })),
                                                  this.engine.cleanupNode(h).nodeBoundFix(h),
                                                  (h._initDD = h._isExternal = h._temporaryRemoved = !0))
                                                : ((h.w = g), (h.h = p), (h._temporaryRemoved = !0)),
                                            l(h.el, !1),
                                            n.get().on(r, "drag", s),
                                            s(o, r, a),
                                            !1
                                    ...
                                    .on(this.el, "drop", (t, e, i) => {
                                        ...
                                        return (
                                            !!s &&
                                            (o && (this.engine.cleanupNode(s), (s.grid = this)),
                                            n.get().off(e, "drag"),
                                            i !== e ? (i.remove(), (e.gridstackNode = l), o && (e = e.cloneNode(!0))) : (e.remove(), n.get().remove(e)),
                                            !!o &&
                                                ((e.gridstackNode = s),
                                                (s.el = e),
                                                ...
                                                this._gsEventHandler.dropped && this._gsEventHandler.dropped({ type: "dropped" }, l && l.grid ? l : void 0, s),
                                                window.setTimeout(() => {
                        ...
                        (o.GridStack.prototype._setupRemoveDrop = function () {
                            if (!this.opts.staticGrid && "string" == typeof this.opts.removable) {
                                ...
                                n.get().isDroppable(t) ||
                                    n
                                        .get()
                                        .droppable(t, this.opts.removableOptions)
                        ...
                        (o.GridStack.setupDragIn = function (t, e) {
                            let i, s;
                            if ((t && ((i = t), (s = Object.assign(Object.assign({}, { revert: "invalid", handle: ".grid-stack-item-content", scroll: !1, appendTo: "body" }), e || {}))), "string" != typeof i)) return;
                            let o = n.get();
                        ...
                        (o.GridStack.prototype._prepareDragDropByNode = function (t) {
                            ...
                            if (this.opts.staticGrid || ((t.noMove || this.opts.disableDrag) && (t.noResize || this.opts.disableResize)))
                                return t._initDD && (i.remove(e), delete t._initDD), e.classList.add("ui-draggable-disabled", "ui-resizable-disabled"), this;
                            if (!t._initDD) {
                                let s,
                                    o,
                                    n = (i, r) => {
                                    ...
                                    a = (s) => {
                                        ...
                                        if (o.gridstackNode && o.gridstackNode.grid === this) {
                                            if (((t.el = o), t._isAboutToRemove)) {
                                                ...
                                                t._temporaryRemoved
                                                    ? (r.Utils.removePositioningStyles(o), r.Utils.copyPos(t, t._orig), this._writePosAttr(o, t), this.engine.addNode(t))
                                                    : (r.Utils.removePositioningStyles(o), this._writePosAttr(o, t)),
                                ...
                                i.draggable(e, { start: n, stop: a, drag: l }).resizable(e, { start: n, stop: a, resize: l }), (t._initDD = !0);
                            }
                            return (
                                t.noMove || this.opts.disableDrag ? (i.draggable(e, "disable"), e.classList.add("ui-draggable-disabled")) : (i.draggable(e, "enable"), e.classList.remove("ui-draggable-disabled")),
                                t.noResize || this.opts.disableResize ? (i.resizable(e, "disable"), e.classList.add("ui-resizable-disabled")) : (i.resizable(e, "enable"), e.classList.remove("ui-resizable-disabled")),
                                this
                            );
                        }),
                        (o.GridStack.prototype._onStartMoving = function (t, e, i, s, o, r) {
                            if (
                                ...
                                delete s._lastTried,
                                "dropover" === e.type && s._temporaryRemoved && (this.engine.addNode(s), (s._moving = !0)),
                                this.engine.cacheRects(o, r, this.opts.marginTop, this.opts.marginRight, this.opts.marginBottom, this.opts.marginLeft),
                                "resizestart" === e.type)
                            ) {
                                let e = n
                                    .get()
                                    .resizable(t, "option", "minWidth", o * (s.minW || 1))
                                    .resizable(t, "option", "minHeight", r * (s.minH || 1));
                        ...
                        (o.GridStack.prototype._leave = function (t, e) {
                            ...
                            i &&
                                ...
                                i._temporaryRemoved ||
                                    ...
                                    t._gridstackNodeOrig ? ((t.gridstackNode = t._gridstackNodeOrig), delete t._gridstackNodeOrig) : i._isExternal && (delete i.el, delete t.gridstackNode, this.engine.restoreInitial())));
                        }),
                        (o.GridStack.prototype._dragOrResize = function (t, e, i, s, o, n) {
                            ...
                            if (this.engine.moveNodeCheck(s, Object.assign(Object.assign({}, a), { cellWidth: o, cellHeight: n, rect: h }))) {
                                (s._lastUiPosition = i.position),
                ...
                62: (t, e, i) => {
                    ...
                    class o {
                        ...
                        _fixCollisions(t, e = t, i, o = {}) {
                            ...
                            let r = e;
                            this._useEntireRowArea(t, e) && ((r = { x: 0, w: this.column, y: e.y, h: e.h }), (i = this.collide(t, r, o.skip)));
                            let n = !1,
                                l = { nested: !0, pack: !1 };
                            for (; (i = i || this.collide(t, r, o.skip)); ) {
                                ...
                                if (
                                    ...
                                    (t._moving &&
                                        ...
                                        e.y > t.y &&
                                        !this.float &&
                                        (!this.collide(i, Object.assign(Object.assign({}, i), { y: t.y }), t) || !this.collide(i, Object.assign(Object.assign({}, i), { y: e.y - i.h }), t)))
                                        ? ((t._skipDown = t._skipDown || e.y > t.y),
                                          (r = this.moveNode(t, Object.assign(Object.assign(Object.assign({}, e), { y: i.y + i.h }), l))),
                                          i.locked && r ? s.Utils.copyPos(e, t) : !i.locked && r && o.pack && (this._packNodes(), (e.y = i.y + i.h), s.Utils.copyPos(t, e)),
                                          (n = n || r))
                                        : (r = this.moveNode(i, Object.assign(Object.assign(Object.assign({}, i), { y: e.y + e.h, skip: t }), l))),
                                    !r)
                                )
                                    return n;
                                i = void 0;
                        ...
                        collideCoverage(t, e, i) {
                            ...
                            return (
                                r.y > o.y ? ((r.h += r.y - o.y), (r.y = o.y)) : (r.h += o.y - r.y),
                                r.x > o.x ? ((r.w += r.x - o.x), (r.x = o.x)) : (r.w += o.x - r.x),
                                i.forEach((t) => {
                        ...
                        cacheRects(t, e, i, s, o, r) {
                            return this.nodes.forEach((n) => (n._rect = { y: n.y * e + i, x: n.x * t + r, w: n.w * t - r - s, h: n.h * e - i - o })), this;
                        }
                        swap(t, e) {
                            ...
                            return (
                                ...
                                this.float
                                    ? this.nodes.forEach((t) => {
                                          ...
                                          let e = t.y;
                                          for (; e > t._orig.y; ) --e, this.collide(t, { x: t.x, y: e, w: t.w, h: t.h }) || ((t._dirty = !0), (t.y = e));
                                      })
                                    : this.nodes.forEach((t, e) => {
                                          if (!t.locked)
                                              for (; t.y > 0; ) {
                                                  let i = 0 === e ? 0 : t.y - 1;
                                                  if (0 !== e && this.collide(t, { x: t.x, y: i, w: t.w, h: t.h })) break;
                        ...
                        prepareNode(t, e) {
                            ...
                            return (
                                ...
                                isNaN(t.x) && ((t.x = i.x), (t.autoPosition = !0)),
                                isNaN(t.y) && ((t.y = i.y), (t.autoPosition = !0)),
                                isNaN(t.w) && (t.w = i.w),
                                isNaN(t.h) && (t.h = i.h),
                        ...
                        nodeBoundFix(t, e) {
                            return (
                                ...
                                t.w > this.column ? (this.column < 12 && ((t.w = Math.min(12, t.w)), this.cacheOneLayout(t, 12)), (t.w = this.column)) : t.w < 1 && (t.w = 1),
                        ...
                        moveNodeCheck(t, e) {
                            ...
                            let i,
                                r = new o({ column: this.column, float: this.float, nodes: this.nodes.map((e) => (e === t ? ((i = Object.assign({}, e)), i) : Object.assign({}, e))) });
                            if (!i) return !1;
                        ...
                        willItFit(t) {
                            ...
                            let e = new o({ column: this.column, float: this.float, nodes: this.nodes.map((t) => Object.assign({}, t)) }),
                                i = Object.assign({}, t);
                        ...
                        changedPosConstrain(t, e) {
                            return (
                                ...
                                t.x !== e.x ||
                                    t.y !== e.y ||
                                    (t.maxW && (e.w = Math.min(e.w, t.maxW)), t.maxH && (e.h = Math.min(e.h, t.maxH)), t.minW && (e.w = Math.max(e.w, t.minW)), t.minH && (e.h = Math.max(e.h, t.minH)), t.w !== e.w || t.h !== e.h)
                            );
                        }
                        moveNode(t, e) {
                            if (!t || !e) return !1;
                ...
                270: (t, e, i) => {
                    ...
                    class a {
                        constructor(t, e = {}) {
                            ...
                            let i = r.Utils.toNumber(t.getAttribute("gs-row")),
                                s = Object.assign(Object.assign({}, l), {
                                    ...
                                    draggable: { handle: (e.handleClass ? "." + e.handleClass : e.handle ? e.handle : "") || ".grid-stack-item-content", scroll: !1, appendTo: "body" },
                                    removableOptions: { accept: "." + (e.itemClass || "grid-stack-item") },
                                });
                            t.getAttribute("gs-animate") && (s.animate = r.Utils.toBool(t.getAttribute("gs-animate"))),
                                (this.opts = r.Utils.defaults(e, s)),
                                (e = null),
                                this.initMargin(),
                                1 !== this.opts.column && !this.opts.disableOneColumnMode && this._widthOrContainer() <= this.opts.minWidth && ((this._prevColumn = this.opts.column), (this.opts.column = 1)),
                            ...
                            if (
                                (n && n.gridstackNode && ((this.opts._isNested = n.gridstackNode), (this.opts._isNested.subGrid = this), this.el.classList.add("grid-stack-nested")),
                                ...
                                this.getGridItems().forEach((e) => {
                                    ...
                                    t.push({ el: e, i: (Number.isNaN(i) ? 1e3 : i) + (Number.isNaN(s) ? 1e3 : s) * this.opts.column });
                                }),
                        ...
                        static init(t = {}, e = ".grid-stack") {
                            ...
                            return i
                                ? (i.gridstack || (i.gridstack = new a(i, Object.assign({}, t))), i.gridstack)
                                : ("string" == typeof e
                                      ? console.error(
                        ...
                        addWidget(t, e) {
                            if (arguments.length > 2) {
                                ...
                                let e = arguments,
                                    i = 1,
                                    s = { x: e[i++], y: e[i++], w: e[i++], h: e[i++], autoPosition: e[i++], minW: e[i++], maxW: e[i++], minH: e[i++], maxH: e[i++], id: e[i++] };
                        ...
                        save(t = !0, e = !1) {
                            ...
                            if (
                                ...
                                return (
                                    s.marginBottom === s.marginTop &&
                                        s.marginRight === s.marginLeft &&
                                        s.marginTop === s.marginRight &&
                                        ((s.margin = s.marginTop), delete s.marginTop, delete s.marginRight, delete s.marginBottom, delete s.marginLeft),
                                    s.rtl === ("rtl" === this.el.style.direction) && (s.rtl = "auto"),
                                    this._isAutoCellHeight && (s.cellHeight = "auto"),
                                    r.Utils.removeInternalAndSame(s, l),
                                    (s.children = i),
                                    s
                                );
                            }
                        ...
                        load(t, e = !0) {
                            ...
                            (this._insertNotAppend = !0),
                                this._prevColumn && this._prevColumn !== this.opts.column && i.some((t) => t.x + t.w > this.opts.column) && ((this._ignoreLayoutsNodeChange = !0), this.engine.cacheLayout(i, this._prevColumn, !0));
                            let s = [];
                            return (
                                this.batchUpdate(),
                                e &&
                        ...
                        getCellHeight(t = !1) {
                            return !this.opts.cellHeight || "auto" === this.opts.cellHeight || (t && this.opts.cellHeightUnit && "px" !== this.opts.cellHeightUnit)
                                ? Math.round(this.el.getBoundingClientRect().height) / parseInt(this.el.getAttribute("gs-current-row"))
                                : this.opts.cellHeight;
                        }
                        cellHeight(t, e = !0) {
                            if (
                                (e && void 0 !== t && this._isAutoCellHeight !== ("auto" === t) && ((this._isAutoCellHeight = "auto" === t), this._updateWindowResizeEvent()), ("initial" !== t && "auto" !== t) || (t = void 0), void 0 === t)
                            ) {
                        ...
                        column(t, e = "moveScale") {
                            ...
                            let i,
                                s = this.opts.column;
                            return (
                                1 === t ? (this._prevColumn = s) : delete this._prevColumn,
                        ...
                        destroy(t = !0) {
                            if (this.el)
                                return (
                                    ...
                                    this.setStatic(!0, !1),
                                    this.setAnimation(!1),
                                    t ? this.el.parentNode.removeChild(this.el) : (this.removeAll(t), this.el.classList.remove(this.opts._styleSheetClass)),
                        ...
                        getCellFromPixel(t, e = !1) {
                            ...
                            i = e ? { top: s.top + document.documentElement.scrollTop, left: s.left } : { top: this.el.offsetTop, left: this.el.offsetLeft };
                            let o = t.left - i.left,
                                r = t.top - i.top,
                                n = s.width / this.opts.column,
                                l = s.height / parseInt(this.el.getAttribute("gs-current-row"));
                            return { x: Math.floor(o / n), y: Math.floor(r / l) };
                        }
                        getRow() {
                        ...
                        on(t, e) {
                            ...
                            if ("change" === t || "added" === t || "removed" === t || "enable" === t || "disable" === t) {
                                ...
                                "drag" === t || "dragstart" === t || "dragstop" === t || "resizestart" === t || "resize" === t || "resizestop" === t || "dropped" === t
                                    ? (this._gsEventHandler[t] = e)
                                    : console.log("GridStack.on(" + t + ') event not supported, but you can still use $(".grid-stack").on(...) while jquery-ui is still used internally.');
                            return this;
                        }
                        off(t) {
                            return -1 !== t.indexOf(" ")
                                ? (t.split(" ").forEach((t) => this.off(t)), this)
                                : (("change" !== t && "added" !== t && "removed" !== t && "enable" !== t && "disable" !== t) || (this._gsEventHandler[t] && this.el.removeEventListener(t, this._gsEventHandler[t])),
                                  delete this._gsEventHandler[t],
                                  this);
                        }
                        removeWidget(t, e = !0, i = !0) {
                            return (
                                a.getElements(t).forEach((t) => {
                        ...
                        setStatic(t, e = !0) {
                            return (
                                this.opts.staticGrid === t || ((this.opts.staticGrid = t), this._setupRemoveDrop(), this._setupAcceptWidget(), this.engine.nodes.forEach((t) => this._prepareDragDropByNode(t)), e && this._setStaticClass()),
                                this
                            );
                        }
                        update(t, e) {
                            ...
                            return (
                                a.getElements(t).forEach((t) => {
                                    ...
                                    o && (this.engine.cleanNodes().beginUpdate(i).moveNode(i, o), this._updateContainerHeight(), this._triggerChangeEvent(), this.engine.endUpdate()),
                                        n && this._writeAttr(t, i),
                                        l && this._prepareDragDropByNode(i);
                                }),
                                this
                            );
                        }
                        ...
                        _updateStyles(t = !1, e) {
                            ...
                            if ((e = e || this._styles._max) > this._styles._max) {
                                ...
                                for (let i = this._styles._max + 1; i <= e; i++) {
                                    let e = t(i);
                                    r.Utils.addCSSRule(this._styles, `${o}[gs-y="${i - 1}"]`, `top: ${t(i - 1)}`),
                                        r.Utils.addCSSRule(this._styles, `${o}[gs-h="${i}"]`, `height: ${e}`),
                                        r.Utils.addCSSRule(this._styles, `${o}[gs-min-h="${i}"]`, `min-height: ${e}`),
                                        r.Utils.addCSSRule(this._styles, `${o}[gs-max-h="${i}"]`, `max-height: ${e}`);
                                }
                                this._styles._max = e;
                            }
                            return this;
                        ...
                        _writePosAttr(t, e) {
                            return (
                                void 0 !== e.x && null !== e.x && t.setAttribute("gs-x", String(e.x)),
                        ...
                        _readAttr(t) {
                            let e = {};
                            (e.x = r.Utils.toNumber(t.getAttribute("gs-x"))),
                                (e.y = r.Utils.toNumber(t.getAttribute("gs-y"))),
                                (e.w = r.Utils.toNumber(t.getAttribute("gs-w"))),
                                (e.h = r.Utils.toNumber(t.getAttribute("gs-h"))),
                                (e.maxW = r.Utils.toNumber(t.getAttribute("gs-max-w"))),
                                (e.minW = r.Utils.toNumber(t.getAttribute("gs-min-w"))),
                                (e.maxH = r.Utils.toNumber(t.getAttribute("gs-max-h"))),
                                (e.minH = r.Utils.toNumber(t.getAttribute("gs-min-h"))),
                                (e.autoPosition = r.Utils.toBool(t.getAttribute("gs-auto-position"))),
                                (e.noResize = r.Utils.toBool(t.getAttribute("gs-no-resize"))),
                                (e.noMove = r.Utils.toBool(t.getAttribute("gs-no-move"))),
                                (e.locked = r.Utils.toBool(t.getAttribute("gs-locked"))),
                        ...
                        _updateWindowResizeEvent(t = !1) {
                            ...
                            return (
                                t || !e || this._windowResizeBind
                                    ? (!t && e) || !this._windowResizeBind || (window.removeEventListener("resize", this._windowResizeBind), delete this._windowResizeBind)
                        ...
                        initMargin() {
                            ...
                            return (
                                ...
                                2 === i.length
                                    ...
                                    : ((t = r.Utils.parseHeight(this.opts.margin)), (this.opts.marginUnit = t.unit), (e = this.opts.margin = t.h)),
                                void 0 === this.opts.marginTop ? (this.opts.marginTop = e) : ((t = r.Utils.parseHeight(this.opts.marginTop)), (this.opts.marginTop = t.h), delete this.opts.margin),
                                void 0 === this.opts.marginBottom ? (this.opts.marginBottom = e) : ((t = r.Utils.parseHeight(this.opts.marginBottom)), (this.opts.marginBottom = t.h), delete this.opts.margin),
                                void 0 === this.opts.marginRight ? (this.opts.marginRight = e) : ((t = r.Utils.parseHeight(this.opts.marginRight)), (this.opts.marginRight = t.h), delete this.opts.margin),
                                void 0 === this.opts.marginLeft ? (this.opts.marginLeft = e) : ((t = r.Utils.parseHeight(this.opts.marginLeft)), (this.opts.marginLeft = t.h), delete this.opts.margin),
                ...
                311: (t, e, i) => {
                    ...
                    class n extends r.DDBaseImplement {
                        ...
                        _dragStart(t) {
                            ...
                            const e = o.DDUtils.initEvent(t, { target: this.el, type: "dragstart" });
                            this.helper !== this.el
                        ...
                        _drag(t) {
                            ...
                            const e = o.DDUtils.initEvent(t, { target: this.el, type: "drag" });
                        ...
                        _dragEnd(t) {
                            ...
                            const e = o.DDUtils.initEvent(t, { target: this.el, type: "dragstop" });
                            this.option.stop && this.option.stop(e), this.triggerEvent("dragstop", e), delete s.DDManager.dragElement, delete this.helper;
                        }
                        _createHelper(t) {
                            let e = this.el;
                            return (
                                "function" == typeof this.option.helper ? (e = this.option.helper(t)) : "clone" === this.option.helper && (e = o.DDUtils.clone(this.el)),
                        ...
                        _setupHelperContainmentStyle() {
                            return (
                                ...
                                "fixed" !== this.option.basePosition &&
                        ...
                        _getDragOffset(t, e, i) {
                            ...
                            if (i) {
                                ...
                                o.DDUtils.addElStyles(t, { opacity: "0", position: "fixed", top: "0px", left: "0px", width: "1px", height: "1px", zIndex: "-999999" }), i.appendChild(t);
                                const e = t.getBoundingClientRect();
                                i.removeChild(t), (s = e.left), (r = e.top);
                            }
                            const n = e.getBoundingClientRect();
                            return { left: n.left, top: n.top, offsetLeft: -t.clientX + n.left - s, offsetTop: -t.clientY + n.top - r, width: n.width, height: n.height };
                        }
                    }
                    (e.DDDraggable = n),
                ...
                54: (t, e, i) => {
                    ...
                    class n extends o.DDBaseImplement {
                        ...
                        _dragEnter(t) {
                            ...
                            this.moving = !0;
                            const e = r.DDUtils.initEvent(t, { target: this.el, type: "dropover" });
                        ...
                        _dragLeave(t) {
                            ...
                            if ((this._removeLeaveCallbacks(), this.moving)) {
                                t.preventDefault();
                                const e = r.DDUtils.initEvent(t, { target: this.el, type: "dropout" });
                        ...
                        _drop(t) {
                            ...
                            t.preventDefault();
                            const e = r.DDUtils.initEvent(t, { target: this.el, type: "drop" });
                        ...
                        _removeLeaveCallbacks() {
                            this.el.removeEventListener("dragleave", this._dragLeave),
                                ...
                                this.moving && (this.el.removeEventListener("dragover", this._dragOver), this.el.removeEventListener("drop", this._drop));
                        }
                        _canDrop() {
                ...
                485: (t, e, i) => {
                    ...
                    class n {
                        ...
                        on(t, e) {
                            return (
                                this.ddDraggable && ["drag", "dragstart", "dragstop"].indexOf(t) > -1
                                    ? this.ddDraggable.on(t, e)
                                    : this.ddDroppable && ["drop", "dropover", "dropout"].indexOf(t) > -1
                                    ? this.ddDroppable.on(t, e)
                                    : this.ddResizable && ["resizestart", "resize", "resizestop"].indexOf(t) > -1 && this.ddResizable.on(t, e),
                                this
                            );
                        }
                        off(t) {
                            return (
                                this.ddDraggable && ["drag", "dragstart", "dragstop"].indexOf(t) > -1
                                    ...
                                    : this.ddResizable && ["resizestart", "resize", "resizestop"].indexOf(t) > -1 && this.ddResizable.off(t),
                                this
                            );
                        }
                        setupDraggable(t) {
                    ...
                    class l extends o.DDBaseImplement {
                        constructor(t, e = {}) {
                            super(),
                                ...
                                (this._ui = () => {
                                    const t = this.el.parentElement.getBoundingClientRect(),
                                        e = { width: this.originalRect.width, height: this.originalRect.height + this.scrolled, left: this.originalRect.left, top: this.originalRect.top - this.scrolled },
                        ...
                        destroy() {
                            this._removeHandlers(),
                                this.option.autoHide && (this.el.removeEventListener("mouseover", this._showHandlers), this.el.removeEventListener("mouseout", this._hideHandlers)),
                        ...
                        _setupAutoHide() {
                            return (
                                this.option.autoHide
                                    ? (this.el.classList.add("ui-resizable-autohide"), this.el.addEventListener("mouseover", this._showHandlers), this.el.addEventListener("mouseout", this._hideHandlers))
                                    : (this.el.classList.remove("ui-resizable-autohide"), this.el.removeEventListener("mouseover", this._showHandlers), this.el.removeEventListener("mouseout", this._hideHandlers)),
                                this
                            );
                        }
                        _setupHandlers() {
                            ...
                            return (
                                "all" === t && (t = "n,e,s,w,se,sw,ne,nw"),
                                (this.handlers = t
                                    .split(",")
                                    .map((t) => t.trim())
                                    .map(
                                        (t) =>
                                            new s.DDResizableHandle(this.el, t, {
                                                start: (t) => {
                                                    this._resizeStart(t);
                                                },
                                                stop: (t) => {
                        ...
                        _resizeStart(t) {
                            (this.originalRect = this.el.getBoundingClientRect()),
                                ...
                                this._setupHelper(),
                                this._applyChange();
                            const e = r.DDUtils.initEvent(t, { type: "resizestart", target: this.el });
                        ...
                        _resizing(t, e) {
                            ...
                            const i = r.DDUtils.initEvent(t, { type: "resize", target: this.el });
                            return this.option.resize && this.option.resize(i, this._ui()), this.triggerEvent("resize", i), this;
                        }
                        _resizeStop(t) {
                            const e = r.DDUtils.initEvent(t, { type: "resizestop", target: this.el });
                            return (
                        ...
                        _setupHelper() {
                            return (
                                (this.elOriginStyleVal = l._originStyleProp.map((t) => this.el.style[t])),
                        ...
                        _getChange(t, e) {
                            ...
                            return (
                                Math.round(s.width) !== Math.round(n.width) && (e.indexOf("w") > -1 && (s.left += s.width - n.width), (s.width = n.width)),
                                Math.round(s.height) !== Math.round(n.height) && (e.indexOf("n") > -1 && (s.top += s.height - n.height), (s.height = n.height)),
                                s
                            );
                        }
                        _constrainSize(t, e) {
                            ...
                            return { width: Math.min(i, Math.max(s, t)), height: Math.min(o, Math.max(r, e)) };
                        }
                        _applyChange() {
                            ...
                            return this.temporalRect
                                ? (Object.keys(this.temporalRect).forEach((e) => {
                ...
                943: (t, e) => {
                    ...
                    class i {
                        ...
                        static initEvent(t, e) {
                            const i = { type: e.type },
                                s = { button: 0, which: 0, buttons: 1, bubbles: !0, cancelable: !0, target: e.target ? e.target : t.target };
                            return (
                                t.dataTransfer && (i.dataTransfer = t.dataTransfer),
                ...
                761: (t, e, i) => {
                    ...
                    class l extends r.GridStackDD {
                        resizable(t, e, i, s) {
                            return (
                                this._getDDElements(t).forEach((t) => {
                                    if ("disable" === e || "enable" === e) t.ddResizable && t.ddResizable[e]();
                                    ...
                                    else if ("option" === e) t.setupResizable({ [i]: s });
                                    else {
                                        ...
                                        t.setupResizable(Object.assign(Object.assign(Object.assign({}, i.opts.resizable), { handles: s }), { start: e.start, stop: e.stop, resize: e.resize }));
                                    }
                                }),
                                this
                            );
                        ...
                        draggable(t, e, i, s) {
                            return (
                                this._getDDElements(t).forEach((t) => {
                                    ...
                                    else if ("option" === e) t.setupDraggable({ [i]: s });
                                    else {
                                        const i = t.el.gridstackNode.grid;
                                        t.setupDraggable(
                                            Object.assign(Object.assign({}, i.opts.draggable), {
                        ...
                        droppable(t, e, i, s) {
                            return (
                                "function" != typeof e.accept || e._accept || ((e._accept = e.accept), (e.accept = (t) => e._accept(t))),
                                this._getDDElements(t).forEach((t) => {
                    ...
                    class i {
                        ...
                        static updateScrollResize(t, e, i) {
                            const s = this.getScrollElement(e),
                                ...
                                n = t.clientY - r,
                                l = n > o - i;
                            n < i ? s.scrollBy({ behavior: "smooth", top: n - i }) : l && s.scrollBy({ behavior: "smooth", top: i - (o - n) });
                        }
                    }
                    e.Utils = i;
                },
