...
!(function (e, t) {
  ...
  function a(e, t, n, i, o) {
    e.style.cssText = 'width:'
      .concat(t, 'px;height:')
      .concat(n, 'px;position:fixed; top:')
      .concat(o, 'px; left:')
      .concat(i, 'px;')
  }
  function c(e) {
  ...
  return (function () {
    function v(t) {
      ...
      if (
        ...
        throw new Error(
          'ImagePreviewer plugin should css string selector that on first params,like #el,.el'
        )
      var i = document.querySelector(t)
      if (!i) throw new Error('selector is invalid')
      this.init()
    }
    var y, w, x
    return (
      ...
      (w = [
        {
          ...
          value: function () {
            var e = this
            ;(this.imageElements = document.querySelectorAll(
              ''.concat(this.selector, ' img:not(#preview-image)')
            )),
        ...
        },
        {
          ...
          value: function () {
            var e = this,
              t = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(
          ...
          value: function () {
            ...
            if (
              ...
              var r = (function (e) {
                ...
                g = r.width,
                p = ''
              h.style.cssText = 'width:'
                .concat(g, 'px;height:auto')
                .concat(p, ';position: fixed; top: ')
                .concat(u, 'px; left: ')
                .concat(f, 'px;')
            } else
        ...
        },
        {
          ...
          value: function (e) {
            ...
            h.classList.add('moving'),
              ...
              (f = { endX: 0, endY: 0, scale: s(o, i, t), rotate: 0 }),
              (h.src = c),
              v.setImageAnimationParams(f),
              setTimeout(function () {
        ...
        },
        {
          ...
          value: function (e) {
            ;(this.index = e),
              (document.getElementById('total-nums').innerText =
